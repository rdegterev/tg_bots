...
from bot.message_workers import ruby_stick_delete, wordle_delete, sorting_hat, pin_message
...
async def add_handlers(dispatcher):
    ...
    dispatcher.register_message_handler(pin_message, lambda msg: '@all' == msg.text[:4] \
                                                                 or '@channel' == msg.text[:8] \
                                                                 or '@канал' == msg.text[:6])
